...
GPIO_init:
	...
	//GPIOA_MODER: PA8 7 6 5: output
	ldr r0, =0b01010101
	lsl r0, 10
	ldr r1, =GPIOA_BASE //GPIOA_MODER
	ldr r2, [r1]
	and r2, 0xFFFC03FF //clear 8 7 6 5
	orrs r2, r2, r0 //8 7 6 5  --> output
	str r2, [r1]

    //GPIOA_OTYPER
	add  r1, 0x4
	ldr  r2, [r1]
	and  r2, 0xFFFFFE1F //(...0001...)
	str  r2, [r1]

	//GPIOA_OSPEEDR
	mov r0, 0b01010101
	lsl r0, 10   //PA8 7,6,5: fast speed
